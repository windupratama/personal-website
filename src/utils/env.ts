/**
 * A utility to ensure the application environment variables are correctly defined
 **/
...
/**
 * Represents the application defined environment variables
 **/
export const env = createEnv({
    server: {
        // Server environtment variables,
